...
public class AllPlasmaAdapter extends RecyclerView.Adapter<AllPlasmaAdapter.ViewHolder> {
    ...
    public AllPlasmaAdapter(Context context, List<PlasmaData> plasmaDataList, BPItemClicklistener bpItemClicklistener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cell.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                bpItemClicklistener.onItemClick(plasmaDataList.get(position));
            }
        });
